    ...
    >
      {NOTIFICATIONS.map((n, i) => (
        ...
        >
          ...
          <span style={{ fontFamily: INTER, fontSize: "10px", color: "rgba(237,233,225,0.22)", flexShrink: 0, letterSpacing: "0.04em" }}>
            {n.time}
          </span>
        </motion.div>
      ))}
  ...
  return (
    <section className="relative py-5 overflow-hidden">
      <div className="max-w-5xl mx-auto px-6 sm:px-12 lg:px-20">
        ...
        {/* Row: InboxPreview + Form side by side */}
        ...
        >
          <h2
            className="font-[var(--font-playfair)] font-black text-white leading-[0.90] mb-4"
          ...
          <p style={{ fontFamily: INTER, fontSize: "clamp(0.875rem, 1.5vw, 1rem)", lineHeight: 1.85, color: "rgba(161,161,170,1)" }}>
