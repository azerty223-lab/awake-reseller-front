...
const YT_VIDEO_ID = "m1SvbXLYEEc"; // Charlotte de Witte @ Awakenings 2025
          ...
          onStateChange: (e) => {
            if (e.data === 1) {
              ...
              pollRef.current = setInterval(() => {
                try {
                  if ((ytPlayerRef.current?.getCurrentTime() ?? 0) >= 32)
  ...
  return (
    ...
    <div ref={containerRef} className="overflow-hidden">
      ...
      >
        ...
        {/* ══ Panel 1 — YouTube video hero ══════════════════════════════ */}
        <div className="relative w-screen h-screen shrink-0 overflow-hidden">

          {/* YouTube player div — replaced by iframe by YT API */}
          <div
            data-parallax
