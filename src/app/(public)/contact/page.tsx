...
// Base input styles — no horizontal padding (applied per-variant below)
const inputBase =
...
// Textarea with left icon: extra left padding + top icon sits at top-3.5
...
// Left-side icon wrapper — works for both inputs (top-1/2) and textareas (top-3.5)
function FieldIcon({
  children,
  align = "center",
}: {
  ...
  return (
    <span
      className={[
        "absolute left-3 pointer-events-none text-zinc-500",
        ...
        {submitted ? (
          ...
          >
            ...
            <div>
              ...
              <div className="relative">
                {/* Icon pinned to top-left — textarea doesn't have a single vertical centre */}
                <FieldIcon align="top">
